...
<head>
    ...
    <script src="/content/scripts/underscore-1.4.4.min.js"></script>
	<script src="/content/scripts/jquery-1.10.0.min.js"></script>
	<script src="/content/scripts/jquery.scrollTo.min.js"></script>
	<script src="/content/scripts/modernizr.min.js"></script>

    <link rel="stylesheet" type="text/css" href="/content/styles/preview-default.css">
</head>
<body>

<!-- <div class="main hideme" data-seq="(steps:[50 100 150 200 250 300 350 400 450 500 550 600 650 700 750 800 850 900 950 1000 1050 1100 1150 1200 1250 1300 1350 1400 1450 1500 1550 1600 1650 1700 1750 1800] set:(background-image:{ a1.jpg a2.jpg a3.jpg a4.jpg a5.jpg a6.jpg a7.jpg a8.jpg a9.jpg a10.jpg a11.jpg a12.jpg a13.jpg a14.jpg a15.jpg a16.jpg a17.jpg a18.jpg a19.jpg a20.jpg a21.jpg a22.jpg a23.jpg a24.jpg a25.jpg a26.jpg a27.jpg a28.jpg a29.jpg a30.jpg a31.jpg a32.jpg a33.jpg a34.jpg a35.jpg a36.jpg}))">
</div>
 -->
...
<div class="floating hideme">

	<div class="left h3 c3" data-seq="(steps:[200 1000] set:(top:{100% -100%}))">Boring</div>
	<div class="right v1 c1" data-seq="(steps:[250 1150] set:(left:{100% -100%}))">Stuck</div>
	<div class="left h1 c2" data-seq="(steps:[450 900] set:(top:{100% -100%}))">Depressed</div>
	<div class="right v2 c2"  data-seq="(steps:[750 1200] set:(left:{-100% 100%}))">Drowning</div>


	<div class="left h3 c3" data-seq="(steps:[500 1500] set:(top:{100% -70%}))">Down</div>
	<div class="right v1 c1" data-seq="(steps:[750 1750] set:(left:{100% -20%}))">F$$$ed</div>
	<div class="left h2 c2" data-seq="(steps:[450 900] set:(top:{100% -70%}))">Blind</div>
	<div class="right v4 c2"  data-seq="(steps:[750 1500] set:(left:{100% -20%}))">Mess up</div>


	<div class="left h1 c1" data-seq="(steps:[0 800] set:(top:{100% -100%}))">Negative</div>
	<div class="right v5 c1" data-seq="(steps:[1000 1300] set:(left:{100% -100%}))">Like Dying!!</div>
	<div class="left h1 c3" data-seq="(steps:[650 1100] set:(top:{100% -100%}))">Not Moving</div>

	<div class="left v2 c1"  data-seq="(steps:[1600 2000] set:(left:{-30% 100%}))">Career</div>
	<div class="left v1 c2"  data-seq="(steps:[1600 2000] set:(top:{100% -70%} left:{0% 100}))">Career</div>
	<div class="left h2 c3"  data-seq="(steps:[1600 2000] set:(left:{100% -30%}))">Career</div>
	<div class="right h1 c4"  data-seq="(steps:[1600 2000] set:(top:{-50% 100%}))">Career</div>
...
<script src="content/scripts/preview-main.min.js"></script>
<script src="content/scripts/preview-core.min.js"></script>
<script src="content/scripts/preview-sequencer.min.js"></script>

<script src="content/scripts/preview-index.min.js"></script>
</body>
</html>
